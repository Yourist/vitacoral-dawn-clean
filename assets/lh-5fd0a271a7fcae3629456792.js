...
if ($review && (window.LAYOUTHUB_LIVE    || window.location.protocol==='blob:')) {
 ...
 };						cb.bind($('section[data-section-id="g5SajtMdv3"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="g5SajtMdv3"]').get(0))({						url: "https://library.layouthub.com/HUB/files/Tm92LS0yMDE5/NTc0ODY0ODc5/First_release/pages/Gent-Detail/product/",						settings: {"trans_label_dd":"Gün","trans_label_hh":"Saat","trans_label_mm":"Dakika","trans_label_ss":"Saniye","trans_unavai":"Stokta Yok","trans_outstock":"Yakında!"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "iml76euvtjd"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="iml76euvtjd"]').get(0))({						url: "https://library.layouthub.com/HUB/files/U2VwLS0yMDIw/NTk5NDQ1MzA1/shopify-third-release/pages/3OoRCAJEsLGr8f1y/Collections/",						settings: {}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "d5y7jonvjgt"							}), success: c, error: e});						}, cb  = function(section, $) {/**
 * Owl Carousel v2.3.4
...
var loop = section.settings.loop,
 ...
 var $this = jQuery(this);
	 $this.find('.lh-slide-wraper').each(function(){
	 let t = $(this);
	 t.dotsClass = "owl-dots lh-container";
	 var owl = $('.owl-carousel',t).owlCarousel({
                loop:slide_loop,
                dots:slide_dot,
		        autoplay: slide_auto,
		        items: 6,
		        dotsClass: t.dotsClass,
		        autoplayTimeout: time_out,
		        startPosition: section.settings.group_slide__active ? section.settings.group_slide__active : 0,
		        animateOut: 'fadeOut',
		        animateIn: 'fadeIn',
		        autoplayTimeout: time_out,
		        responsive:{
            ...
            $('.lh-nav-slider .owl-prev', t).click(function(ev) {
				ev.preventDefault();
			    owl.trigger('prev.owl.carousel');
			});
			$('.lh-nav-slider .owl-next', t).click(function(ev) {
				ev.preventDefault();
			    owl.trigger('next.owl.carousel');
			})
});

 };						cb.bind($('section[data-section-id="d5y7jonvjgt"] include[data-name="slide"][data-id="1"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="d5y7jonvjgt"]').get(0))({						url: "https://library.layouthub.com/HUB/files/U2VwLS0yMDIw/NTk5NDQ1MzA1/shopify-third-release/pages/uCiQMkJNFtjKhdUO/partner/",						settings: {"loop":"yes","auto":"yes","dot_show":"no","time":"5","group_slide__active":6}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "tajsjbqnu8s"							}), success: c, error: e});						}, cb  = function(section, $) {window.HUB = window.HUB || {};
